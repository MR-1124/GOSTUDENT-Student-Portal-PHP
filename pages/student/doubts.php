...
?>
<h4 class="center-align">My Doubts</h4>
<div class="row">
    <div class="col s12 m8 offset-m2">
        <div class="card">
            <div class="card-content">
                <span class="card-title">Post a Doubt</span>
                <form method="POST">
                    ...
                    <div class="input-field">
                        ...
                        <label for="content">Doubt Details</label>
                    </div>
                    <div class="center-align">
                        <button type="submit" name="post_doubt" class="btn waves-effect waves-light">Post Doubt</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="row">
    ...
    while ($doubt = $stmt->fetch()) {
        ...
        if ($doubt['resolved']) {
            ...
            echo '<button type="submit" name="resolve_doubt" class="btn-small waves-effect waves-light teal darken-1">Mark Resolved</button>';
            echo '</form>';
        }
        // Fetch replies
